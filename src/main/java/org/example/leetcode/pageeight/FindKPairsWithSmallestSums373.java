...
public class FindKPairsWithSmallestSums373 {
    ...
    public static void main(String[] args) {
        FindKPairsWithSmallestSums373 findKPairsWithSmallestSums = new FindKPairsWithSmallestSums373();
        int[] nums1 = {1, 7, 11};
        int[] nums2 = {2, 4, 6};
//        int[] nums1 = {1, 1, 2};
//        int[] nums2 = {1, 2, 3};
...
//        int[] nums2 = {3};
        ...
        List<List<Integer>> results = findKPairsWithSmallestSums.kSmallestPairs(nums1, nums2, 4);
